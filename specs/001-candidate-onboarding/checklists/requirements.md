...
**Prerrequisito externo de esta feature.** La tabla "Estado de verificación" del ADR-011 está sin llenar. FR-009 impide ofrecer un proveedor sin verificación empírica registrada, así que sin esa tabla el paso 1 del wizard no tiene lista que mostrar. Es trabajo del ADR-011 (roadmap §10, paso 2), y `/speckit-plan` debe tratarlo como dependencia, no como detalle.
